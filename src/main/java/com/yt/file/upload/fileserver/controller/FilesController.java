...
public class FilesController {
	...
	@ResponseBody
	public List<FilesEntity> listFilesByPage(@PathVariable int pageIndex, @PathVariable int pageSize) {
	...
	public String handleFileUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {
		...
		try {
			FilesEntity f = new FilesEntity(file.getOriginalFilename(), file.getContentType(), file.getSize(),
	...
	public ResponseEntity<String> handleFileUpload(@RequestParam("file") MultipartFile file) {
		FilesEntity returnFilesEntity = null;
		try {
			FilesEntity f = new FilesEntity(file.getOriginalFilename(), file.getContentType(), file.getSize(),
					new Binary(file.getBytes()));
			f.setMd5(MD5Util.getMD5(file.getInputStream()));
